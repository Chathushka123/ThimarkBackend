   ...
   // private $qr;
    ...
    public function generateMarkerPlan($request){
        ...
        try {
            ...
            DB::table('marker_plan')->where('style_code',$style_code)->where('fabric',$fabric)->delete();
            ...
            while($found){
                ...
                if(!(array_sum($ratio) > 0)){
                    throw new \App\Exceptions\GeneralException("Marker Plan Can't Generate");
                }
