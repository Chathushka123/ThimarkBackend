        ...
        <tr>
            ...
            <td class="sticker-td">
                <table class="sticker" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="sticker-qr">
                            <img src="data:image/png;base64, {!! base64_encode(QrCode::format('svg')->size(55)->generate((string) $trolley->id)) !!} ">
                        </td>
                        <td class="sticker-info">
                            <div class="info-label">ID</div>
                            <div class="info-value info-id">{{ $trolley->id }}</div>
                            <div class="info-label">Code</div>
                            <div class="info-value">{{ $trolley->code }}</div>
                            <div class="info-label">Name</div>
                            <div class="info-value">{{ $trolley->name }}</div>
                        </td>
                    </tr>
                </table>
            </td>
