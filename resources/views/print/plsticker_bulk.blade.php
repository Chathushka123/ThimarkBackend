...
<?php $count = 0; $rows =0; ?>
<table cellspacing="10" cellpadding="5" border="1" width="100%" style="border-color:#333; border-collapse: collapse;   margin-top:27px; margin-left:-33px; margin-right:-6px; margin-bottom:-80px">
        ...
        <th>
            <table cellspacing="" cellpadding="0" border="0" width="100%" style="border-color:#333; border-collapse: collapse;max-height:50px; min-height:50px; ">
                ...
                <tr style = "font-size:10px; ">
                    ...
                    <th colspan="4" style = " text-align:left;">{{$rec->soc[0]->wfx_soc_no}} / {{$rec->soc[0]->wfx_fpo_no}}</th>
                </tr>
                <tr style = "font-size:8px; ">
