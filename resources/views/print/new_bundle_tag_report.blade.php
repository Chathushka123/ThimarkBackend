                            ...
                            <table cellspacing="1" cellpadding="1" border="0" width="100%"  style="border-color:#333; ">
                               ...
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <th colspan="5" class="common" style="font-size:8px">{{$rec->special_remark}}</th>
                                </tr>
                                ...
                                <tr>
                                    <th  colspan="2" class="common" ><img
                                            src="data:image/png;base64, {!! base64_encode(QrCode::format('svg')->size(40)->generate($id)) !!} "></th>
                                    <th colspan="5" class="common" style="font-weight:50 "><p>*{{$id}}* </p></th>

                                </tr>
                                 <tr>
                                    <th  colspan="4" class="common" style="   font-weight:50; text-align:right; padding-bottom: 5px; font-size : 10px" ><b>{{$id}}</b></th>
