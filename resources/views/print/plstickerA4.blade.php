    ...
    @foreach($cartons as $rec)
        ...
        <th style="width:33.3%">
            <table cellspacing="" cellpadding="0" border="0" width="100%" style="border-color:#333; border-collapse: collapse;max-height:500px; min-height:500px">
                ...
                <?php  $str_soc = substr($str_soc,0,50)  ?>
                ...
                <tr style = "font-size:8px; ">
                    <th  style = " text-align:center; font-weight:50">Des : </th>
                    <th colspan="3" style = " text-align:left;">{{$packing_style->destination}}</th>
                </tr>
                <tr style = "font-size:8px; ">
                    <th  style = " text-align:center; font-weight:50">PK ID : </th>
                    <th colspan="3" style = " text-align:left;">{{$packing_style->pkId}}</th>
                </tr>
