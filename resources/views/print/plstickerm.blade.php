        ...
        <th>
            <table cellspacing="" cellpadding="0" border="0" width="100%" style="border-color:#333; border-collapse: collapse;max-height:50px; min-height:50px">
                ...
                <tr style = "font-size:10px;">
                    ...
                    <th colspan="2" style = " text-align:left; ">{{$rec->style->vpo}}</th>
                ...
                @foreach($rec->soc as $soc_rec)
                    <?php $color=$soc_rec->pack_color; $colorName = $soc_rec->ColorName; $str_soc .= $soc_rec->wfx_soc_no." "; $str_fpo .= $soc_rec->wfx_fpo_no." "; ?>
                @endforeach

                @foreach($qty as $key=>$val)
                    @if(intval($val) > 0)
                        <?php $size .= $key."(".$val*$rec->pack_ratio_sum.")"." "; ?>
                    @endif
                @endforeach
                ...
                <tr style = "font-size:9.5px;">
                    ...
                    <th colspan="3" style = " text-align:left; border-top:1px solid black">{{$rec->style->style_code}}</th>
                </tr>
                ...
                <tr style = "font-size:8px; ">
                    ...
                    <th colspan="4" style = " text-align:left;">{{$rec->style->destination}}</th>
                </tr>
