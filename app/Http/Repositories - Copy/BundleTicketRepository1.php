...
//            $nowDate = new \DateTime("now");
		   ...
		   $all_tickets = BundleTicket::select('bundle_tickets.*','fpo_operations.operation','fpo_operations.operation_code','routing_operations.wfx_seq')
		   ->join('fpo_operations','fpo_operations.id', '=','bundle_tickets.fpo_operation_id' )
...
//            print_r($receivedDateYMD);
		...
		//   ->where('bundle_id',$bundle_ticket->bundle_id)
		 ...
		 //  ->get();
		   ...
		   $all_tickets = DB::select('select bundle_tickets.*, fpo_operations.operation, fpo_operations.operation_code 
from bundle_tickets 
...
where bundle_tickets.bundle_id = 25269
