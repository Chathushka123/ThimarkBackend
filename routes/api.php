...
Route::prefix('v1')->group(function () {
    ...
    Route::group(['middleware' => 'auth:api'], function () {
        ...
        Route::post('inventory/getLocationAvaileMaterial', 'InventoryController@getLocationAvaileMaterial')->name('inventory.getLocationAvaileMaterial');
        Route::post('inventory/transferStockItem', 'InventoryController@transferStockItem')->name('inventory.transferStockItem');
